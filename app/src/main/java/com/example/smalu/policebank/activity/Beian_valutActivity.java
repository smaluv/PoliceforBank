...
public class Beian_valutActivity extends Activity {
    ...
    private void InitViewPager() {
        ...
        listViews.add(mInflater.inflate(R.layout.beian_valut_1, null));
        listViews.add(mInflater.inflate(R.layout.beian_valut_2, null));
        listViews.add(mInflater.inflate(R.layout.beian_valut_3, null));
